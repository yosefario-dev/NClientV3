...
import com.yosefario.nclientv3.api.components.Ranges;
import com.yosefario.nclientv3.api.components.Tag;
import com.yosefario.nclientv3.api.enums.ApiRequestType;
import com.yosefario.nclientv3.api.enums.Language;
import com.yosefario.nclientv3.api.enums.SortType;
import com.yosefario.nclientv3.api.enums.SpecialTagIds;
...
public class MainActivity extends BaseActivity
    ...
    private void loadStringLogin() {
        ...
        if (com.yosefario.nclientv3.settings.Login.getUser() != null)
            loginItem.setTitle(getString(R.string.login_formatted, com.yosefario.nclientv3.settings.Login.getUser().getUsername()));
        else
            loginItem.setTitle(com.yosefario.nclientv3.settings.Login.isLogged() ? R.string.logout : R.string.login);
    ...
    private void changeNavigationImage(NavigationView navigationView) {
        boolean isLight = Global.getTheme() == Global.ThemeScheme.LIGHT;
        View view = navigationView.getHeaderView(0);
        ImageView imageView = view.findViewById(R.id.imageView);
        View layoutHeader = view.findViewById(R.id.layout_header);
        ImageDownloadUtility.loadImage(Global.getLogo(), imageView);
        layoutHeader.setBackgroundResource(isLight ? R.drawable.side_nav_bar_light : R.drawable.side_nav_bar_dark);
    }
    ...
    protected void onResume() {
        ...
        com.yosefario.nclientv3.settings.Login.initLogin(this);
