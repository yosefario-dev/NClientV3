package com.yosefario.nclientv3.async;
...
public class VersionChecker {
    private static final String RELEASE_API_URL = "https://api.github.com/repos/yosefario-dev/NClientV3/releases";
    private static final String LATEST_RELEASE_URL = "https://github.com/yosefario-dev/NClientV3/releases/latest";
